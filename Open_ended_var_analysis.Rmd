...
dd <- open %>%
  ...
  filter(!is.na(method), !str_detect(tolower(method), "none"))

dd$method <- str_to_title(dd$method)

dd$method <- sapply(dd$method, standardize_law, USE.NAMES = FALSE)
dd$method[1] <- NA
dd$method[2] <- "Questionnaires, Observation, Interviews"
dd$method[3] <- "Questionnaires,Interviews"
